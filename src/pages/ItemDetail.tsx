...
const ItemDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Main Content - with top padding for fixed header and bottom padding for fixed bar */}
      <main className="pt-16 pb-36 max-w-md mx-auto">
        {/* Image Gallery */}
        <div className="relative bg-secondary/30">
          <div className="aspect-[4/3] w-full overflow-hidden flex items-center justify-center">
            <motion.img
              ...
              loading="lazy"
              onError={(e) => {
                e.currentTarget.src = 'https://images.unsplash.com/photo-1624371414361-e670edf4898d?w=800';
              }}
            />
          </div>
